...
6. Мастер проверяет обновления каждые 2.5 секунды в течение двух минут, сам найдёт `chat_id` либо предложит выбрать чат, сохранит настройки и пришлёт тестовое сообщение.
